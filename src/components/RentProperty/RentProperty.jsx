...
const RentProperty = () => {
  ...
  const [RentPropertyData, setRentPropertyData] = useState([]);
  ...
  const allpropertyid = RentPropertyData.map((data) => {
    if (data?._id) {
      return data?.id;
    }
    return data.id;
  ...
  //console.log("🚀 ~ RentProperty ~ encryptedData----------------------------------------------------------------------------->:", encryptedData)
    ...
    await axiosInstance
      ...
      .then((res) => {
        ...
        if (res?.data?.status) {
          ...
          setIsLoading(false);
          setRentPropertyData(newResponse);
  ...
  const filterData = (searchTerm) => {
    ...
    setRentPropertyData(filteredArray);
  };
  ...
  return (
    <Layout1>
          ...
          <div className="w-full grid grid-cols-1 2xl:grid-cols-12 place-items-center 2xl:place-items-start xl:place-items-center 2xl:gap-5 gap-10">
            <div className="w-full grid col-span-1 2xl:col-span-8">
              ...
              <div className="flex md:flex-row flex-col justify-between bg-white rounded-2xl shadow-sm hover:shadow-md p-5 mb-10 gap-x-5">
                <div className="flex flex-col justify-start">
                  ...
                  <div className="text-[#737373] font-normal text-xs md:text-sm lg:text-base mt-1">
                    1-{RentPropertyData?.length} of {RentPropertyData?.length}{" "}
                    results
                  </div>
                </div>
              ...
              {isLoading ? (
                ...
                <PropertySoldCard
                  PropertyData={RentPropertyData}
                  setPropertyData={setRentPropertyData}
                  style="mb-10"
            ...
            <div className="grid col-span-1 2xl:col-span-4 place-content-start">
              <PropertyShowcaseCard PropertyData={RentPropertyData} />
      ...
      <FilterScreenModel
        ...
        currentTab={"Rent"}
        id={first}
        dataCount={RentPropertyData?.length}
      />
    </Layout1>
  );
};
